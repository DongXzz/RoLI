...
_C.TRAIN_MODE = "clean"
_C.ADV = CfgNode()
_C.ADV.TRAIN_ATTACK_EPS = 0.01568627
_C.ADV.TRAIN_ATTACK_STEPS = 3
_C.ADV.VAL_ATTACK_EPS =  0.01568627
_C.ADV.VAL_ATTACK_STEPS =  10
_C.ADV.HALF_ADV = False
_C.ADV.TRAIN_RANDOMSTART = True
_C.ADV.VAL_RANDOMSTART = True
_C.DATA.TRAIN_NUM_PERCENT = 100
_C.DATA.TRAIN_SPLIT_PERCENT = 90
_C.VAL_FREQ = 1
_C.MODEL.VIS = False
_C.MODEL.SAVE_CHECKPOINT = False
_C.MODEL.RESIZE = True
_C.MODEL.WEIGHT_STRICT = True

# LoRA
_C.MODEL.LORA = CfgNode()
_C.MODEL.LORA.RANK = 16
_C.MODEL.LORA.DROPOUT = 0.1
_C.MODEL.LORA.ALPHA = 16
_C.MODEL.LORA.ZEROINIT = False
