...
"""JSON dataset: support CUB, Dogs and Caltech256"""
...
class Caltech256(JSONDataset):
    """Caltech256 dataset."""

    def __init__(self, cfg, split):
        super(Caltech256, self).__init__(cfg, split)

    def get_imagedir(self):
        return os.path.join(self.data_dir, "256_ObjectCategories")
