...
class CifarData(base.ImageTfdsData):
  ...
  def __init__(self, num_classes=10, data_dir=None, train_split_percent=None, train_num_percent=100):
    ...
    trainval_count = train_num_percent * trainval_count // 100
    num_samples_splits = {
    ...
    tfds_splits = {
        ...
        "val": "train[{}:{}]".format(
            num_samples_splits["train"], num_samples_splits["train"]+num_samples_splits["val"]),
        "trainval": "train[:{}]".format(num_samples_splits["train"]+num_samples_splits["val"]),
        "test": "test",
    }
