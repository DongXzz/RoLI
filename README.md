...
We use CIFAR-10 and CIFAR-100 from [Visual Task Adaptation Benchmark](https://google-research.github.io/task_adaptation/) (VTAB). Please see [`VTAB_SETUP.md`](https://github.com/KMnP/vpt/blob/main/VTAB_SETUP.md) for instructions. Note, only CIFAR-10 and CIFAR-100 are required. We follow the official train/test splits and the size of validation set is specified in [TRAIN_SPLIT_PERCENT](src/data/vtab_datasets/cifar.py) in configs.
